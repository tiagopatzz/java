...
public class Funcionario implements User
{
    ...
    public Funcionario(int id, String nome, String endereco, Data dataNascimento, String logName, String hashCode, double salario)
    {
        this.id = id;
        this.nome = nome;
    ...
    public Funcionario( int id, String logName, String hashCode )
    {
        this.id = id;
        this.nome = "";
        this.endereco = "";
